...
namespace PracticalTest.Models
{
	internal partial class Passanger
	{
		...
		public string FlightFromEurope { get; set; }
		public Passanger(string name, string email, string address, int day, int month,
						int year, string gender, string meal, string flightDestination, string flightClass, string flightFromEurope )// Consturctor for creating passanger in mongoDB database
		{
			Name = name;
			Email = email;
			Adress = address;
			...
			FlightFromEurope = flightFromEurope;
		}
		public Passanger(string name, string email, string adress, int day, int month, int year, string gender) // Constructor to validate required code
		{
			Name = name;
			Email = email;
			Adress = adress;
